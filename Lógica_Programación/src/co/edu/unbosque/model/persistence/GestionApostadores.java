...
public class GestionApostadores {
	...
	/**
	 * Obtener datos apostador.
	 *
	 * @param indiceApostador the indice apostador
	 * @return the string
	 */
	public String obtenerDatosApostador(int indiceApostador) {
		return (
				"Nombre completo del apostador: " + apostadores.get(indiceApostador).getNombreCompleto() + "\n"
				+ "Cedula del apostador: " + apostadores.get(indiceApostador).getCedula() + "\n"
				+ "Sede Actual del apostador: " + apostadores.get(indiceApostador).getSedeActual() + "\n"
				+ "Direccion del apostador: " + apostadores.get(indiceApostador).getDireccion() + "\n"
				+ "Celular del apostador: " + apostadores.get(indiceApostador).getCelular()
				);
	}
