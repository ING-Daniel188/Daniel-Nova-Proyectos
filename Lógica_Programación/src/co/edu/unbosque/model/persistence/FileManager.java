...
public class FileManager {
	...
	/** The archivo sedes. */
	private String archivoSedes = "sedes.dat";
	
	/** The archivo apostadores. */
	private String archivoApostadores = "apostadores.dat";
	
	/** The archivo juegos. */
	private String archivoJuegos = "juegos.dat";
	
	/** The archivo loteria. */
	private String archivoLoteria = "apuestas-loteria.dat";
	
	/** The archivo super astro. */
	private String archivoSuperAstro = "apuestas-superastro.dat";
	
	/** The archivo baloto. */
	private String archivoBaloto = "apuestas-baloto.dat";
	
	/** The archivo bet play. */
	private String archivoBetPlay = "apuestas-betplay.dat";
	
	/** The archivo equipos. */
	private String archivoEquipos = "equipos.txt";
	
	/** The archivo chance. */
	private String archivoChance = "apuestas-chance.dat";
