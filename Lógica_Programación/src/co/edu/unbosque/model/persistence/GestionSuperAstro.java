...
public class GestionSuperAstro {
	...
	public String obtenerDatosApuestas(String cedula, String dia) {
		...
		for (SuperAstro apuestaSuperAstro: apuestasSuperAstro) {
			if (apuestaSuperAstro.getCedulaApostador().equals(cedula)
					&& apuestaSuperAstro.getDia().equals(dia)) {
				datosApuestas += ("Nombre de la sede: " + apuestaSuperAstro.getNombreSede() + "\n" +
						"Cedula del apostador: " + apuestaSuperAstro.getCedulaApostador() + "\n" +
						"Dia de la apuesta: " + apuestaSuperAstro.getDia() + "\n" +
						"Valor de la apuesta: " + apuestaSuperAstro.getValor() + "\n" +
						"Numero de loteria: " + Arrays.toString(apuestaSuperAstro.getNumerosSeleccionados()) + "\n" +
						"Signo del Zodiaco: " + apuestaSuperAstro.getSignoDelZodiaco() + "\n\n"
						);
			}
		}
