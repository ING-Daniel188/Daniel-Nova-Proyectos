...
/**
 * The Class EliminacionDeUsuario.
 */
public class EliminacionDeUsuario extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 151412590485931415L;
	...
	/**
	 * Instantiates a new eliminacion de usuario.
	 */
	public EliminacionDeUsuario() {
		setBorder(new TitledBorder("Eliminar Usuario"));
		...
		JLabel etiquetaIdUsuario = new JLabel("Número de Documento:");
		add(etiquetaIdUsuario, restricciones);
	...
	/**
	 * Mostrar mensaje usuario eliminado.
	 */
	public void mostrarMensajeUsuarioEliminado() {
		JOptionPane.showMessageDialog(this, "El usuario ha sido eliminado exitosamente.", "Usuario Eliminado",
