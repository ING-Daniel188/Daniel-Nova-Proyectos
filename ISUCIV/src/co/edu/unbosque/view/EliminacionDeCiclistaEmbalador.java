...
/**
 * The Class EliminacionDeCiclistaEmbalador.
 */
public class EliminacionDeCiclistaEmbalador extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -2226281399939889010L;
	...
	/**
	 * Instantiates a new eliminacion de ciclista embalador.
	 */
	public EliminacionDeCiclistaEmbalador() {
		setBorder(new TitledBorder("Eliminar Ciclista Embalador"));
	...
	/**
	 * Mostrar mensaje ciclista embalador eliminado.
	 */
	public void mostrarMensajeCiclistaEmbaladorEliminado() {
		JOptionPane.showMessageDialog(this, "El ciclista embalador ha sido eliminado exitosamente.",
				"Ciclista Embalador Eliminado", JOptionPane.INFORMATION_MESSAGE);
	}
