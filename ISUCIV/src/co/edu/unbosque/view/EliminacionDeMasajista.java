...
/**
 * The Class EliminacionDeMasajista.
 */
public class EliminacionDeMasajista extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5483680711677147861L;
	...
	/**
	 * Instantiates a new eliminacion de masajista.
	 */
	public EliminacionDeMasajista() {
		setBorder(new TitledBorder("Eliminar Masajista"));
	...
	/**
	 * Mostrar mensaje masajista eliminado.
	 */
	public void mostrarMensajeMasajistaEliminado() {
		JOptionPane.showMessageDialog(this, "El masajista ha sido eliminado exitosamente.", "Masajista Eliminado",
