...
/**
 * The Class EliminacionDeCiclistaClasicomano.
 */
public class EliminacionDeCiclistaClasicomano extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5786502912776917416L;
	...
	/**
	 * Instantiates a new eliminacion de ciclista clasicomano.
	 */
	public EliminacionDeCiclistaClasicomano() {
		setBorder(new TitledBorder("Eliminar Ciclista Clasicómano"));
	...
	/**
	 * Mostrar mensaje ciclista clasicomano eliminado.
	 */
	public void mostrarMensajeCiclistaClasicomanoEliminado() {
		JOptionPane.showMessageDialog(this, "El ciclista clasicómano ha sido eliminado exitosamente.",
				"Ciclista Clasicómano Eliminado", JOptionPane.INFORMATION_MESSAGE);
	}
