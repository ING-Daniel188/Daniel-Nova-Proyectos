...
/**
 * The Class ActualizacionDeCiclistaGregario.
 */
public class ActualizacionDeCiclistaGregario extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 308140767851980101L;
	...
	/**
	 * Instantiates a new actualizacion de ciclista gregario.
	 */
	public ActualizacionDeCiclistaGregario() {
		setBorder(new TitledBorder("Actualizar Ciclista Gregario"));
		...
		add(new JLabel("Nueva Función en Pelotón:"));
	...
	public void habilitarEntradasYBotonActualizar() {
		...
		seleccionFuncionEnPeloton.setEnabled(true);
	...
	public void deshabilitarEntradasYBotonActualizar() {
		...
		seleccionFuncionEnPeloton.setEnabled(false);
	...
	/**
	 * Mostrar mensaje ciclista gregario actualizado.
	 */
	public void mostrarMensajeCiclistaGregarioActualizado() {
		JOptionPane.showMessageDialog(this, "Ciclista Gregario actualizado exitosamente.",
				"Ciclista Gregario Actualizado", JOptionPane.INFORMATION_MESSAGE);
	}
