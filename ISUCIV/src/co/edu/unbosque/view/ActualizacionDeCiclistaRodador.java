...
/**
 * The Class ActualizacionDeCiclistaRodador.
 */
public class ActualizacionDeCiclistaRodador extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1511674947708845815L;
	...
	/**
	 * Instantiates a new actualizacion de ciclista rodador.
	 */
	public ActualizacionDeCiclistaRodador() {
		setBorder(new TitledBorder("Actualizar Ciclista Rodador"));
	...
	/**
	 * Mostrar mensaje ciclista rodador actualizado.
	 */
	public void mostrarMensajeCiclistaRodadorActualizado() {
		JOptionPane.showMessageDialog(this, "Ciclista Rodador actualizado exitosamente.",
				"Ciclista Rodador Actualizado", JOptionPane.INFORMATION_MESSAGE);
	}
