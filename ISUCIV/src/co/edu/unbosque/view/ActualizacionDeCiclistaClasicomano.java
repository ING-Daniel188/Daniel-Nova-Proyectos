...
/**
 * The Class ActualizacionDeCiclistaClasicomano.
 */
public class ActualizacionDeCiclistaClasicomano extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6155661332828620623L;
	...
	/**
	 * Instantiates a new actualizacion de ciclista clasicomano.
	 */
	public ActualizacionDeCiclistaClasicomano() {
		setBorder(new TitledBorder("Actualizar Ciclista Clasicómano"));
		...
		add(new JLabel("Nuevo Número de Clásicos Ganados:"));
	...
	public void habilitarEntradasYBotonActualizar() {
		...
		campoNumeroClasicosGanados.setEnabled(true);
	...
	public void deshabilitarEntradasYBotonActualizar() {
		...
		campoNumeroClasicosGanados.setEnabled(false);
	...
	/**
	 * Mostrar mensaje ciclista clasicomano actualizado.
	 */
	public void mostrarMensajeCiclistaClasicomanoActualizado() {
		JOptionPane.showMessageDialog(this, "Ciclista Clasicómano actualizado exitosamente.",
				"Ciclista Clasicómano Actualizado", JOptionPane.INFORMATION_MESSAGE);
	}
