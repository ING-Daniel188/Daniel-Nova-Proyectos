...
/**
 * The Class EliminacionDeDirectorDeportivo.
 */
public class EliminacionDeDirectorDeportivo extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 576479760992791637L;
	...
	/**
	 * Instantiates a new eliminacion de director deportivo.
	 */
	public EliminacionDeDirectorDeportivo() {
		setBorder(new TitledBorder("Eliminar Director Deportivo"));
	...
	/**
	 * Mostrar mensaje director deportivo eliminado.
	 */
	public void mostrarMensajeDirectorDeportivoEliminado() {
		JOptionPane.showMessageDialog(this, "El director deportivo ha sido eliminado exitosamente.", "Director Deportivo Eliminado",
