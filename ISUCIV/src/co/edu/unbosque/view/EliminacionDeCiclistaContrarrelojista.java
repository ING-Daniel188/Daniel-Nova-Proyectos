...
/**
 * The Class EliminacionDeCiclistaContrarrelojista.
 */
public class EliminacionDeCiclistaContrarrelojista extends JPanel {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -326447242525480091L;
	...
	/**
	 * Instantiates a new eliminacion de ciclista contrarrelojista.
	 */
	public EliminacionDeCiclistaContrarrelojista() {
		setBorder(new TitledBorder("Eliminar Ciclista Contrarrelojista"));
	...
	/**
	 * Mostrar mensaje ciclista contrarrelojista eliminado.
	 */
	public void mostrarMensajeCiclistaContrarrelojistaEliminado() {
		JOptionPane.showMessageDialog(this, "El ciclista contrarrelojista ha sido eliminado exitosamente.",
				"Ciclista Contrarrelojista Eliminado", JOptionPane.INFORMATION_MESSAGE);
	}
