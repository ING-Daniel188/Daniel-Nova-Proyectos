...
/**
 * The Class PanelCreacionFrutaAcida.
 */
public class PanelCreacionFrutaAcida extends PanelCreacionProducto {
	...
	/**
	 * Instantiates a new panel creacion fruta acida.
	 */
	public PanelCreacionFrutaAcida() {
		getLabelTitulo().setText("Crear Fruta Ácida");
		...
		labelIntensidad = new JLabel("Intensidad del Ácido");
	...
	public boolean validarEntradas() {
		...
		if (seleccionableIntensidad.getSelectedIndex() == 0) {
			super.mostrarMensajeError("La intensidad del ácido de la fruta no ha sido seleccionada");
			return false;
		}
		
		if (seleccionableEsOrganica.getSelectedIndex() == 0) {
			super.mostrarMensajeError("No se ha seleccionado si la fruta ácida es orgánica o no");
			return false;
		}
		return true;
	}
